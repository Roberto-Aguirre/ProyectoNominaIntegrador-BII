...
namespace ProyectoNominaINTBII.Controllers
{
    ...
    public class SatTipoJornadasController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<SatTipoJornadum>> GetSatTipoJornada(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutSatTipoJornada(int id, SatTipoJornadum satTipoJornada)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<SatTipoJornadum>> PostSatTipoJornada(SatTipoJornadum satTipoJornada)
        {
