...
namespace ProyectoNominaINTBII.Controllers
{
    ...
    public class SatBancosController : ControllerBase
    {
        ...
        public SatBancosController(ProyBd2bContext context)
        {
            _context = context;
        }
        ...
        // GET: api/SatBancos
        [HttpGet]
        public async Task<ActionResult<IEnumerable<SatBanco>>> GetSatBancos()
        {
            return await _context.SatBancos.ToListAsync();
        }

        // GET: api/SatBancos/5
        [HttpGet("{id}")]
        public async Task<ActionResult<SatBanco>> GetSatBanco(int id)
        {
