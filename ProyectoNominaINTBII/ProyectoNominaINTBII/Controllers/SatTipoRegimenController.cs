...
namespace ProyectoNominaINTBII.Controllers
{
    ...
    public class SatTipoRegimenController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<SatTipoRegimen>>> GetSatTipoRegimen()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<SatTipoRegimen>> GetSatTipoRegimen(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutSatTipoRegimen(int id, SatTipoRegimen satTipoRegimen)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<SatTipoRegimen>> PostSatTipoRegimen(SatTipoRegimen satTipoRegimen)
        {
